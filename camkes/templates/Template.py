...
TEMPLATES = {
    ...
    'eChronos':{ # eChronos RTOS
        Guard(lambda x: isinstance(x, Connection) and x.type.name == 'eChronosDirectCall'): {
            'from':{
        ...
        Guard(lambda x: isinstance(x, Connection) and x.type.name == 'eChronosAsynch'): {
            'from':{
    ...
    'linux':{
        ...
        Guard(lambda x: isinstance(x, Connection) and x.type.name == 'linuxMQ'):{
            'from':{
        ...
        Guard(lambda x: isinstance(x, Connection) and x.type.name == 'linuxMQEmpty'):{
            'from':{
        ...
        Guard(lambda x: isinstance(x, Connection) and x.type.name == 'linuxMmap'):{
            'from':{
        ...
        'wrapper':'linux/wrapper.template.sh',
    },
}
