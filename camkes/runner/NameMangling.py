...
DERIVATIONS = {
    RUNNER:[
        ...
        ControlDeriver(r'^_control_max_priority$', 'max_priority_attribute'),
        FromControlDeriver('_control_max_priority', 'max_priority_attribute'),
        ...
        ControlDeriver(r'^_control_criticality$', 'criticality_attribute'),
        FromControlDeriver('_control_criticality', 'criticality_attribute'),
        ...
        ControlDeriver(r'^_control_max_criticality$', 'max_criticality_attribute'),
        FromControlDeriver('_control_max_criticality', 'max_criticality_attribute'),
        ...
        ControlDeriver(r'^_control_sc$', 'sc_attribute'),
        FromControlDeriver('_control_sc', 'sc_attribute'),
        ForwardDeriver('%(interface)s_sc', 'sc_attribute'),
        BackwardDeriver(r'^([^_].*)_sc$', 'sc_attribute', 'interface'),

        ControlDeriver(r'^_control_period$', 'period_attribute'),
        FromControlDeriver('_control_period', 'period_attribute'),
